...
public class QueryStudentDemo {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      students = session.createQuery("from Student s where s.lastName = 'Brute'").getResultList();
      ...
      students = session.createQuery("from Student s where s.lastName = 'Brute' OR s.lastName = 'Geek'")
          .getResultList();
      ...
      students = session.createQuery("from Student s where s.email like '%g1rl%'").getResultList();
